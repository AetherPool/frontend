...
export const getFeeCalculatorContract = (
  providerOrSigner: ethers.Provider | ethers.Signer
) =>
  new ethers.Contract(
...
export const getConfigManagerContract = (
  providerOrSigner: ethers.Provider | ethers.Signer
) =>
  new ethers.Contract(
...
export const getHookSwapRouterContract = (
  providerOrSigner: ethers.Provider | ethers.Signer
) =>
  new ethers.Contract(
...
export const getJITCoordinatorContract = (
  providerOrSigner: ethers.Provider | ethers.Signer
) =>
  new ethers.Contract(
...
export const getProfitManagerContract = (
  providerOrSigner: ethers.Provider | ethers.Signer
) =>
  new ethers.Contract(
